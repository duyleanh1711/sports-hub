...
const ListBox = <T extends object>({
  ...
  <ListBoxPrimitive
    ...
    data-slot="list-box"
    className={cx(
      "max-h-96 w-full min-w-56 scroll-py-1 flex-col gap-y-1 overflow-y-auto overscroll-contain rounded-xl border bg-bg p-1 outline-hidden [scrollbar-width:thin] has-data-[slot=drag-icon]:grid-cols-[auto_auto_1fr] [&::-webkit-scrollbar]:size-0.5 *:[[role='group']+[role=group]]:mt-4 *:[[role='group']+[role=separator]]:mt-1",
      className,
    )}
  />
);
