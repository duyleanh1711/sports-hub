      ...
      className={composeRenderProps(
        ...
        (className, { isPressed, isFocusVisible, isHovered, isDisabled }) =>
          twMerge([
            ...
            "p-2 has-[a]:p-0",
            // icon
            "**:data-[slot=icon]:shrink-0 [&_[data-slot='icon']:not([class*='size-'])]:size-5 sm:[&_[data-slot='icon']:not([class*='size-'])]:size-5 [&_[data-slot='icon']:not([class*='text-'])]:text-muted-fg",
            ...
            isCurrent &&
              "font-medium text-(--sidebar-current-fg) bg-primary/10 hover:bg-(--sidebar-current-bg) hover:text-(--sidebar-current-fg) [&_.text-muted-fg]:text-fg/80 [&_[data-slot='icon']:not([class*='text-'])]:text-(--sidebar-current-fg) hover:[&_[data-slot='icon']:not([class*='text-'])]:text-(--sidebar-current-fg)",
            isFocusVisible &&
