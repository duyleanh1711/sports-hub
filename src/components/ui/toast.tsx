...
export function Toast(props: ToasterProps) {
  ...
  return (
    <ToasterPrimitive
      ...
      toastOptions={{
        className: twJoin(
          "font-sans not-has-data-[slot=note]:backdrop-blur-3xl will-change-transform *:data-[slot=note]:relative *:data-[slot=note]:z-50 *:data-icon:mt-0.5 *:data-icon:self-start has-data-description:*:data-icon:mt-1",
