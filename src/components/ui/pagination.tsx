...
const Pagination = ({
  ...
  <nav
    ...
    className={twMerge(
      "flex w-full items-center gap-(--pagination-gap) [--pagination-gap:--spacing(2)] [--section-radius:calc(var(--radius-lg)-1px)] **:data-[slot=control]:w-auto",
    ...
    <li>
      <Link
        ...
        className={buttonStyles({
          ...
          className: twMerge(
            "touch-target min-w-9 shrink-0 cursor-pointer!",
            className,
          ),
        })}
        {...props}
    ...
    <li>
      <Link
        ...
        className={buttonStyles({
          ...
          isCircle,
          intent,
          className: twMerge("shrink-0 cursor-pointer!", className),
        })}
        {...props}
      >
